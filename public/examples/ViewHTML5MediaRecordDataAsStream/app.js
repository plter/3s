...
/******/ 	return __webpack_require__(__webpack_require__.s = "./SubProjects/FrontEnd/ViewHTML5MediaRecordDataAsStream/src/index.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./SubProjects/FrontEnd/ViewHTML5MediaRecordDataAsStream/src/Constants.js":
/*!********************************************************************************!*\
  !*** ./SubProjects/FrontEnd/ViewHTML5MediaRecordDataAsStream/src/Constants.js ***!
  \********************************************************************************/
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony default export */ __webpack_exports__[\"default\"] = ({\n    MIME_TYPE: 'video/webm; codecs=\"opus,vp8\"'\n});\n\n//# sourceURL=webpack:///./SubProjects/FrontEnd/ViewHTML5MediaRecordDataAsStream/src/Constants.js?");

/***/ }),

/***/ "./SubProjects/FrontEnd/ViewHTML5MediaRecordDataAsStream/src/components/ViewHTML5MediaRecordDataAsStream.js":
/*!******************************************************************************************************************!*\
  !*** ./SubProjects/FrontEnd/ViewHTML5MediaRecordDataAsStream/src/components/ViewHTML5MediaRecordDataAsStream.js ***!
  \******************************************************************************************************************/
/*! no exports provided */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _html_ViewHTML5MediaRecordDataAsStream_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../html/ViewHTML5MediaRecordDataAsStream.html */ \"./SubProjects/FrontEnd/ViewHTML5MediaRecordDataAsStream/src/html/ViewHTML5MediaRecordDataAsStream.html\");\n/* harmony import */ var _html_ViewHTML5MediaRecordDataAsStream_html__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_html_ViewHTML5MediaRecordDataAsStream_html__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _pipelines_ArrayBufferToVideoElement__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../pipelines/ArrayBufferToVideoElement */ \"./SubProjects/FrontEnd/ViewHTML5MediaRecordDataAsStream/src/pipelines/ArrayBufferToVideoElement.js\");\n/* harmony import */ var _Constants__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../Constants */ \"./SubProjects/FrontEnd/ViewHTML5MediaRecordDataAsStream/src/Constants.js\");\n/* harmony import */ var _pipelines_MediaStreamBlobToArrayBuffer__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../pipelines/MediaStreamBlobToArrayBuffer */ \"./SubProjects/FrontEnd/ViewHTML5MediaRecordDataAsStream/src/pipelines/MediaStreamBlobToArrayBuffer.js\");\n/* harmony import */ var _tools__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../tools */ \"./SubProjects/FrontEnd/ViewHTML5MediaRecordDataAsStream/src/tools.js\");\n\n\n\n\n\n\nVue.component(\"viewhtml5mediarecorddataasstream\", {\n    template: _html_ViewHTML5MediaRecordDataAsStream_html__WEBPACK_IMPORTED_MODULE_0___default.a,\n    created() {\n\n    },\n\n    mounted() {\n        this._pipeline = new _pipelines_ArrayBufferToVideoElement__WEBPACK_IMPORTED_MODULE_1__[\"default\"](this.$refs.preview);\n        this._blobToArrayBufferPipeline = new _pipelines_MediaStreamBlobToArrayBuffer__WEBPACK_IMPORTED_MODULE_3__[\"default\"](this.gotBufferHandler.bind(this));\n\n        this._asyncInit();\n    },\n\n    methods: {\n        btnRefreshClickedHandler(e) {\n            if (this._currentMediaRecorder) {\n                this._currentMediaRecorder.ondataavailable = null;\n                this._currentMediaRecorder.stop();\n            }\n\n            let mr = this._currentMediaRecorder = new MediaRecorder(this._stream, {mimeType: _Constants__WEBPACK_IMPORTED_MODULE_2__[\"default\"].MIME_TYPE});\n            mr._isFirstBuffer = true;\n            mr.ondataavailable = this.mediaRecorderDataAvailableHandler.bind(this);\n            mr.start(200);\n        },\n\n        mediaRecorderDataAvailableHandler(e) {\n            this._blobToArrayBufferPipeline.appendBlob(e.data, e.target._isFirstBuffer);\n            e.target._isFirstBuffer = false;\n        },\n\n        gotBufferHandler(arrayBuffer, isFirstPart) {\n            this._pipeline.addBuffer(arrayBuffer, isFirstPart);\n        },\n\n        async _asyncInit() {\n            this._stream = await navigator.mediaDevices.getUserMedia({audio: true, video: true});\n\n            await _tools__WEBPACK_IMPORTED_MODULE_4__[\"default\"].sleep(1000);//在Firefox中，不休眠会出现一些问题，可能是因为HTMLVideoElement元素未初始化完成所导致。\n            this.btnRefreshClickedHandler();\n        }\n    }\n});\n\n//# sourceURL=webpack:///./SubProjects/FrontEnd/ViewHTML5MediaRecordDataAsStream/src/components/ViewHTML5MediaRecordDataAsStream.js?");

/***/ }),

/***/ "./SubProjects/FrontEnd/ViewHTML5MediaRecordDataAsStream/src/html/ViewHTML5MediaRecordDataAsStream.html":
/*!**************************************************************************************************************!*\
  !*** ./SubProjects/FrontEnd/ViewHTML5MediaRecordDataAsStream/src/html/ViewHTML5MediaRecordDataAsStream.html ***!
  \**************************************************************************************************************/
...
eval("module.exports = \"<div style=\\\"margin: 10px;\\\">\\n    <video width=\\\"400\\\" height=\\\"300\\\" autoplay ref=\\\"preview\\\"></video>\\n    <div>\\n        <button class=\\\"btn btn-primary\\\" @click=\\\"btnRefreshClickedHandler\\\">Refresh</button>\\n    </div>\\n</div>\";\n\n//# sourceURL=webpack:///./SubProjects/FrontEnd/ViewHTML5MediaRecordDataAsStream/src/html/ViewHTML5MediaRecordDataAsStream.html?");

/***/ }),

/***/ "./SubProjects/FrontEnd/ViewHTML5MediaRecordDataAsStream/src/index.js":
/*!****************************************************************************!*\
  !*** ./SubProjects/FrontEnd/ViewHTML5MediaRecordDataAsStream/src/index.js ***!
  \****************************************************************************/
/*! no exports provided */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _components_ViewHTML5MediaRecordDataAsStream__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/ViewHTML5MediaRecordDataAsStream */ \"./SubProjects/FrontEnd/ViewHTML5MediaRecordDataAsStream/src/components/ViewHTML5MediaRecordDataAsStream.js\");\n\n\nnew Vue({\n    el: \"viewhtml5mediarecorddataasstream\"\n});\n\n//# sourceURL=webpack:///./SubProjects/FrontEnd/ViewHTML5MediaRecordDataAsStream/src/index.js?");

/***/ }),

/***/ "./SubProjects/FrontEnd/ViewHTML5MediaRecordDataAsStream/src/pipelines/ArrayBufferToVideoElement.js":
/*!**********************************************************************************************************!*\
  !*** ./SubProjects/FrontEnd/ViewHTML5MediaRecordDataAsStream/src/pipelines/ArrayBufferToVideoElement.js ***!
  \**********************************************************************************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony default export */ __webpack_exports__[\"default\"] = ({\n    sleep(ms) {\n        return new Promise(resolve => {\n            setTimeout(resolve, ms);\n        });\n    }\n});\n\n//# sourceURL=webpack:///./SubProjects/FrontEnd/ViewHTML5MediaRecordDataAsStream/src/tools.js?");

/***/ }),

/***/ "./SubProjects/FrontEnd/ViewHTML5MediaRecordDataAsStream/src/vo/MediaStreamPartBlob.js":
/*!*********************************************************************************************!*\
  !*** ./SubProjects/FrontEnd/ViewHTML5MediaRecordDataAsStream/src/vo/MediaStreamPartBlob.js ***!
  \*********************************************************************************************/
/*! exports provided: default */
